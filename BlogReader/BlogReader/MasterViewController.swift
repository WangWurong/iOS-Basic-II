...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // get the url, and there is no uncertainty in the value
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/2399953/posts?key=AIzaSyDsfuV2dUdKzdO2Al_TXZMtxUGn0lNN7PI")!
                                ...
                                if results.count > 0 {
                                    for result in results {
                                        ...
                                        do {
                                            ...
                                            print("failed to delete the speicified result")
                                        }
                                    }
                                }
